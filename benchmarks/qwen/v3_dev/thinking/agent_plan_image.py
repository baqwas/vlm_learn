...
ax.text(
    5, 8.1, "Thinking Model", ha="center", va="center", fontsize=12, color="darkgreen"
)
...
ax.add_patch(
    plt.Rectangle(
        (4, 6.5), 2, 0.8, color="white", alpha=0.9, edgecolor="darkgray", linewidth=0.5
    )
)
ax.text(
    5, 6.9, "1. PERCEPTION", ha="center", va="center", fontsize=10, fontweight="bold"
)
...
ax.add_patch(
    plt.Rectangle(
        (4, 4.5), 2, 1.2, color="white", alpha=0.9, edgecolor="darkgray", linewidth=0.5
    )
)
ax.text(
    5, 5.3, "2. REASONING", ha="center", va="center", fontsize=10, fontweight="bold"
)
...
ax.add_patch(
    plt.Rectangle(
        (4, 2.5), 2, 0.8, color="white", alpha=0.9, edgecolor="darkgray", linewidth=0.5
    )
)
ax.text(
    5, 2.9, "3. ACTION PLAN", ha="center", va="center", fontsize=10, fontweight="bold"
)
...
ax.text(
    8.25,
    5.2,
    "e.g., Search Query, Click Sequence",
    ha="center",
    va="center",
    fontsize=8,
    color="darkgray",
