...
DEFAULT_TEMPERATURE: float = (
    0.1  # Low temperature for reliable, deterministic classification
)
...
def main():
    ...
    try:
        ...
        print("\n" + "=" * 80)
        print(
            f"RAPID EXTRACTION AND CLASSIFICATION DEMONSTRATION (Qwen3-VL 2B Instruct)"
        )
        print(
            f"Optimization: Initial Max tokens: {DEFAULT_MAX_NEW_TOKENS}, Temperature: {DEFAULT_TEMPERATURE}."
        )
        print("=" * 80)
        ...
        for task in rapid_tasks:
            ...
            response, duration = rapid_assistant.run_rapid_task(
        ...
        print(
            "This speed is achieved by dynamically forcing extremely short, focused outputs."
        )
        print("=" * 80)
        ...
        print(
            "Please ensure all dependencies are installed and system resources are sufficient."
        )
