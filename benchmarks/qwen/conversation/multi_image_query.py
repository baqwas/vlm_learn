...
local_image_path1 = "../images/hpi_annuals.png"
image1 = Image.open(local_image_path1).convert("RGB")
local_image_path2 = "../images/barchart.png"
image2 = Image.open(local_image_path2).convert("RGB")
...
query = "The first image is total revenue for the company, the second image is one division of another company. Based on the two images, which company is doing better over the reported period?"
...
inputs = processor(
    ...
    images=[image1, image2],  # Pass the PIL Image object here
    return_tensors="pt",
).to(model.device)
