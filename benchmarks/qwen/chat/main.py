...
# -*- coding: utf-8 -*-
"""
A simple example of a LangGraph agent that uses a vision-capable LLM to analyze images
and extract text from them using a custom tool.
@see https://github.com/t-redactyl/ocr-llm-agent/
...
from qwen_v2d5.chat.agent.tools import (
    extract_text,
)
