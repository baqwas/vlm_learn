...
ax.text(
    1.5, 7.7, "(Text or Image)", ha="center", va="center", fontsize=9, color="black"
)
...
ax.text(
    5, 4, "Language Processing", ha="center", va="center", fontsize=8, color="darkgreen"
)
...
ax.text(
    5,
    1.5,
    "Real-time, Iterative Conversation",
    ha="center",
    va="center",
    fontsize=10,
    color="gray",
