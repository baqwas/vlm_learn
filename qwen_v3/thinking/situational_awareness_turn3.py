...
ax.plot(agent_position_turn_3[0], agent_position_turn_3[1], 'k^', markersize=12, label='Agent Current Position (Returned to Start)')
ax.annotate('Agent Returned to Start', agent_position_turn_3, textcoords="offset points", xytext=(-20, 5), ha='right', fontsize=9, fontweight='bold')
...
ax.plot([10, 11, 11, 10, 10], [4, 4, 5, 5, 4], 'k--', alpha=0.8, linewidth=2, label='Memory Focus Area (Turn 1)')
ax.text(10.5, 3.5, 'Crucial Detail Recalled (Green Sphere)', fontsize=9, ha='center', color='black', fontweight='bold')

# Visualize the final action target
ax.annotate('TARGET: Pick up Green Sphere', object_positions["Green Sphere"],
            textcoords="offset points", xytext=(15, 0), arrowprops=dict(arrowstyle="->", color='g', linewidth=2),
...
ax.set_title('Simulated Environment Map (Turn 3: Long-Context Memory & Action)', fontsize=14)
