...
def generate_vlm_dashboard(csv_file):
    ...
    bars = ax.barh(
        phases["Task Name"], phases["Progress"], color=colors, edgecolor="white"
    )
    ...
    summary = "Milestone Summary:\n" + "\n".join(
        [f"• {s}: {c}" for s, c in milestone_stats.items()]
    )
    ...
    plt.text(
        ...
        bbox=dict(
            facecolor="white", alpha=0.9, edgecolor="#bdc3c7", boxstyle="round,pad=1"
        ),
