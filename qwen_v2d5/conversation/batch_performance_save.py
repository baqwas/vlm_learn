...
def text_image_generation_local(image_folder_path, output_log_file, db_config):
    ...
    try:
        ...
        if err.errno == mariadb.constants.ER_ACCESS_DENIED_ERROR:
            print("Something is wrong with your user name or password.")
        elif err.errno == mariadb.constants.ER_BAD_DB_ERROR:
...
if __name__ == "__main__":
    ...
    if os.path.exists(config_file_name):
        ...
        if "Database" in config:
            ...
            print(
                f"Warning: No '[Database]' section found in '{config_file_name}'. Database operations will likely fail."
            )
    else:
        print(
