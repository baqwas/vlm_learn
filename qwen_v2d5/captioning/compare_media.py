...
# local_image1_path = "../images/023_2.jpg"
# local_image2_path = "/home/reza/Videos/opencv/vlm/qwen2.5-vl/bridge.jpg"
local_image1_path = "../../images/exercises/cars1.jpg"
local_image2_path = "../../images/exercises/cars2.jpg"
# local_image_path = "/home/reza/Videos/opencv/vlm/qwen2.5-vl/images/traffic.png"
image1 = Image.open(local_image1_path).convert("RGB")
image2 = Image.open(local_image2_path).convert("RGB")
...
# query = "What is the name of the river in these images?"
# query = "What is the city is in the images?"
query = "What are the differences between the car in the first image and the car in the second image?"
